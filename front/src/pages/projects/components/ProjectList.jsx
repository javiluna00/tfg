          ...
          {activeProjects.map((project) => (
            <div className='card w-full flex flex-col items-center justify-center h-[100vh]' key={project.id}>
              ...
              <div className='izquierda-bl flex-col justify-start items-start'>
                ...
                <h5 className='font-bold text-5xl lg:text-7xl text-white tracking-widest uppercase'>{project.name}</h5>
                ...
                {project.spotify_link &&
                  <div className='w-96 flex justify-start items-center mt-10'>
                    ...
                    <iframe src={`https://open.spotify.com/embed${project.spotify_link.replace('https://open.spotify.com/intl-es', '')}?utm_source=generator`} width='100%' height='100%' loading='lazy' />
