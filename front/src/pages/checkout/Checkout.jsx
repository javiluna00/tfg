...
const Checkout = () => {
  ...
  const { removeItem, totalPrice, subTotalPrice, cart, pay, isEmpty } = useCartActions()
  ...
  return (
    <div className='min-h-[90vh] bg-zinc-950'>
            ...
            <div>
              ...
              <div className='flex flex-col justify-start items-start gap-5 p-5 bg-zinc-700 rounded-lg mt-5'>
                <div className='flex justify-between items-center w-full'>
                  ...
                  <p className='text-zinc-400 text-sm'>{subTotalPrice()}€</p>
                </div>
