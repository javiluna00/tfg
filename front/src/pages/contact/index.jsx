...
function Contact () {
  ...
  const { sendForm } = useContact({ AxiosPrivate })
            ...
            <form className='w-full' onSubmit={handleSubmit(onSubmit)}>
              <div className='flex flex-col items-start w-full h-full'>
                ...
                <textarea
                  ...
                  className='resize-none rounded-md border border-gray-300 bg-white py-3 px-6 w-full text-base font-medium text-[#6B7280] outline-none focus:border-red-400 focus:shadow-md'
                />
                <div className='separator my-4' />
