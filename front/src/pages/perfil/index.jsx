...
const Perfil = () => {
  const { AxiosPrivate, logOut } = useOutletContext()
  const { loadProfileData, loading } = useProfile({ AxiosPrivate })
            ...
            : <div className='space-y-5 profile-page'>
              ...
              <div className='rounded-lg grid grid-cols-12 gap-6 bg-white dark:bg-slate-800 mb-6'>
                ...
                <div className='lg:col-span-8 col-span-12'>
                  <Card title='Acciones'>
                    {!auth?.user?.google_id && <Button className='w-full bg-primary-500 text-white hover:bg-primary-600 transition-all duration-150' variant='outlined'>Cambiar contraseña</Button>}
