...
const Login = () => {
  ...
  const {isAuthenticated, endGoogleLogin} = useAuth()
...
const onSubmitArtistName = (data) => {
  try{
    endGoogleLogin(tempAccessToken, tempGoogleInfo, data.artist_name)
  }
  catch (error) {
    toast.error(error.message);
  }
  ...
  const setActiveArtistNameSection = (resGoogle, access_token) => {
            ...
            <div className="inner-content h-full flex flex-col bg-white dark:bg-slate-800">´
              ...
              {artistNameSection == false ? 
                <div className="auth-box h-full flex flex-col justify-center">
                  ...
                  <Social activeArtistName={setActiveArtistNameSection}/>
                  </div>
              ...
              :
                <div className="auth-box h-full flex flex-col justify-center">
                  ...
                  <Button text="Terminar sin nombre artístico" className="bg-transparent text-slate-500 block w-full text-center hover:text-slate-700 duration-300" onClick={() => setArtistNameSection(false)}/>
                  <Button
                    type="submit"
                    text="Enviar"
